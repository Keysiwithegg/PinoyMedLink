...
{{--              </span>--}}
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Patient Prescription (example of a static link) -->
        <li class="menu-item {{ Request::is('doctor/prescription*') ? 'active' : '' }}">
            <a href="{{route('doctor.prescription.index')}}" class="menu-link">
